  ...
  return (
    <header className="mw8 center ph3 ph5-ns pv5 bg-yellow black-80 tc">
      ...
      <div className="pv2 ph2 tc-l">
        <button type="button" className="pointer grow no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2 bn" title="Twitter" onClick={(e) => props.handleClick(e)}>
