  ...
  return (
    <header className="mw7 center ph3 ph5-ns pv5 bg-yellow black-80 tc">
      ...
      <div className="pv2 ph2 tc-l">
        <div className="pointer no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" onClick={() => props.handleClick()} title="Twitter">
